...
{url-cl}1.7.6$$...$$main[Full Changelog]

.Added

.Changed
- Bumped spring-boot, springmockk, wicket-jquery-ui, spring-boot-admin-starter, jasperreports
  gradle versions plugin, lombok-gradle-plugin
