...
{url-cl}1.7.5$$...$$main[Full Changelog]

.Added

.Changed
- Bump spring-boot, gradle-wrapper, flyway, wicket-jquery-ui, KRis-core, mockk, openfeign, versions gradle plugin,
  equalsverifier, spring-boot-admin
