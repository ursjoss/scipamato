...
{url-cl}1.5.0$$...$$main[Full Changelog]
...
.Changed
- Bumped spring-boot, wicket, wicket-bootstrap, wicket-jquery-ui, jOOQ, detekt, mockk, kluent, kwik, kris, jasperreports
  font-awesome, flyway, gradle, equalsverifier, lombok-gradle-plugin
...
.Fixed
- {url-issues}1114[#1114] Reactivate integration-tests for SciPaMaTo public-web
