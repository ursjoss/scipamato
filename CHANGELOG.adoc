...
.Changed
- Bumped wicket, wicket-bootstrap, wicket-jquery-ui, jOOQ, detekt, mockk, kwik, kris, jasperreports
  font-awesome, flyway, gradle
- Kotlin Conversion of common-pesistence-api, common-persistence-jooq, common-wicket
