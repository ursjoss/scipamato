...
open class SimpleFilterPanel(
    ...
    override fun onInitialize() {
        ...
        addCodesComplex("studyDesignCodes", PublicPaperFilterFields.STUDY_DESIGN_CODES, StudyDesignCode.values(), "220px")
    ...
    private fun addTextFieldTo(id: String, filterField: PublicPaperFilterFields) {
        object : TextField<String>(id, PropertyModel.of(model, filterField.fieldName)) {
    ...
    private fun <C : Enum<C>?> addCodesComplex(
        id: String,
        filterField: PublicPaperFilterFields,
        values: Array<C>,
        width: String,
    ) {
        ...
        val model = PropertyModel.of<Collection<C>>(model, filterField.fieldName)
    ...
    private fun queueKeywordMultiselect(
        ...
        val model = PropertyModel.of<List<Keyword>>(model, filterField.fieldName)
        val choiceRenderer = ChoiceRenderer<Keyword>(Keyword.KeywordFields.DISPLAY_VALUE.fieldName, Keyword.KeywordFields.ID.fieldName)
        val config = BootstrapSelectConfig()
            .withMultiple(true)
            .withActionsBox(true)
            .withSelectAllText(StringResourceModel(SELECT_ALL_RESOURCE_TAG, this, null).string)
