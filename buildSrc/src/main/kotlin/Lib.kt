...
object Lib {
    ...
    private const val springBootVersion = "2.4.1"
    private const val springBootAdminVersion = "2.3.1"
    const val springCloudVersion = "2020.0.0-RC1"
    private const val springCloudStarterVersion = "3.0.0-RC1"
