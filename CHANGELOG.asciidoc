...
:icons: font
:iu: https://github.com/ursjoss/scipamato/issues/
ifdef::env-github[]
:tip-caption: :bulb:
...
.Added
- {iu}1[#1]: Translate Exception into more user friendly form: DataViolationException
...
.Fixed
- {iu}2[#2]: Error when creating literature review PDF after using the browsers back
  button (10/15)
