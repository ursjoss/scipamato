...
- Feature 6/21: Add Menu Link to the github wiki page (Help)
- Feature 6/24: Add Menu Link with build version number pointing to the CHANGELOG document on github 
...
- Bug 6/22: Parsing Authors from PubmedXml: Delimiter between normal authors and authors with CollectiveName needs to be semicolon.
