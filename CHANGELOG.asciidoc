...
.Changed
- Bumped kotlin, detekt, KRis, kwik, wicket-boostrap, font-awesome, junit-jupter, kluent, mockk
  spring-cloud, wicket, KRis, testcontainers, lombok-gradle-plugin

.Deprecated

.Removed
- apache-io, commons-lang3, jool
