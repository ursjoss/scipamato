...
.Added
- #1: Translate Exception into more user friendly form: DataViolationException
  when trying to delete code

.Changed
- Bumpted dependencies: wicket 8.2.0, wicket-spring-boot-starter 2.1.5, wicket-bootstrap 2.0.6
...
.Fixed
- #2: Error when creating literature review PDF after using the browsers back
  button (10/15)
