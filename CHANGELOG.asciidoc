...
.Changed
- Core: 06/21+24: Open external links in new browser tab
...
.Fixed
- Commented out dependency for spring-boot-admin, as it is not available on maven-central and thus breaks the build (unless you compile it yourself)
