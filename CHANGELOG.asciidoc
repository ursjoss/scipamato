...
{url-cl}<prev>$$...$$master[Full Changelog]
...
{url-cl}1.4.5$$...$$master[Full Changelog]

.Added

.Changed
- Bumped spring-boot-starter, spring-boot-admin, spring-cloud-starter, KRis, kotlin-logging, jaxb-impl,
  detekt, gradle-wrapper, spek, gadle, wicket-jquery-ui, equalsverifier, testcontainers
