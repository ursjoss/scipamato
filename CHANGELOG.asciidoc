...
- Updated to wicket-7.9.0, bumped wicket-spring-boot-starter, jOOQ, feign
- dependency updates: jooq-3.10.1
...
.Fixed
- Fix version alignment of jooq-codegen-maven-plugin with jooq
- Fix versions of jooq and the postgres jdbc driver in the main jar
