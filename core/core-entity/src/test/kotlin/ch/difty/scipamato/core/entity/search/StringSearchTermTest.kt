...
internal class StringSearchTermTest {
    ...
    fun assertTokenTypes() {
        values() shouldContainAll listOf(NOTREGEX, REGEX, WHITESPACE, SOME, EMPTY,
    ...
    fun assertTokenTypes_like() {
        byMatchType(MatchType.LIKE) shouldContainAll listOf(NOTOPENLEFTRIGHTQUOTED, OPENLEFTRIGHTQUOTED,
