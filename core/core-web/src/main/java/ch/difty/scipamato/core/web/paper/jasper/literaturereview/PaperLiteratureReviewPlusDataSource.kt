 ...
 */
class PaperLiteratureReviewPlusDataSource(
    ...
    override fun getParameterMap(): HashMap<String, Any> = hashMapOf("show_goal" to true)
    ...
    companion object {
        ...
        private const val FILE_NAME = "paper_literature_review_plus"
    }
}
