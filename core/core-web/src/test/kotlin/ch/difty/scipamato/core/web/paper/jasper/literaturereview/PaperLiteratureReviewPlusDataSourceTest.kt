...
internal class PaperLiteratureReviewPlusDataSourceTest : PaperDataSourceTest() {

    private lateinit var ds: PaperLiteratureReviewPlusDataSource
    ...
    private fun assertDataSource(fileName: String) {
        ...
        ds.reportParameters["show_goal"] shouldBeEqualTo true
    ...
    fun instantiatingWithProvider_returnsPdfDataSourceWithOneRecord() {
        ...
        ds = PaperLiteratureReviewPlusDataSource(dataProviderMock, rhf, pdfExporterConfigMock)
    ...
    companion object {
        private const val FILE_NAME = "paper_literature_review_plus.pdf"
