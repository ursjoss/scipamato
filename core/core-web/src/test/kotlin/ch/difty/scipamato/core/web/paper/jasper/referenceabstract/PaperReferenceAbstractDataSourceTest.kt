...
internal class PaperReferenceAbstractDataSourceTest : PaperDataSourceTest() {

    private lateinit var ds: PaperReferenceAbstractDataSource
    ...
    public override fun setUpHook() {
        ...
        every { paperMock.originalAbstract } returns "oa"
    ...
    private fun assertDataSource(fileName: String) {
        ...
        assertFieldValue("abstract", "oa", f, jsds)
    ...
    fun instantiatingWithProvider_returnsPdfDataSourceWithOneRecord() {
        ...
        ds = PaperReferenceAbstractDataSource(dataProviderMock, rhf, pdfExporterConfigMock)
        ...
        verify { paperMock.originalAbstract }
    ...
    companion object {
        private const val FILE_NAME = "paper_reference_abstract.pdf"
