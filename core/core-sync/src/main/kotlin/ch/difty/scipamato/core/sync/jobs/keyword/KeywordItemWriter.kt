 ...
 */
class KeywordItemWriter(
    jooqDslContextPublic: DSLContext,
) : ScipamatoItemWriter<PublicKeyword>(jooqDslContextPublic, "keyword") {

    override fun executeUpdate(i: PublicKeyword): Int =
        dslContext
            .insertInto(Keyword.KEYWORD)
            .columns(Keyword.KEYWORD.ID, Keyword.KEYWORD.KEYWORD_ID, Keyword.KEYWORD.LANG_CODE, Keyword.KEYWORD.NAME,
                Keyword.KEYWORD.VERSION, Keyword.KEYWORD.CREATED, Keyword.KEYWORD.LAST_MODIFIED,
                Keyword.KEYWORD.LAST_SYNCHED, Keyword.KEYWORD.SEARCH_OVERRIDE)
            .values(
                i.id, i.keywordId, i.langCode, i.name, i.version, i.created,
                i.lastModified, i.lastSynched, i.searchOverride
