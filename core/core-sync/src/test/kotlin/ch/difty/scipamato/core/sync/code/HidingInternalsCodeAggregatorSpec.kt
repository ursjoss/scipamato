...
@Suppress("unused")
object HidingInternalsCodeAggregatorSpec : DescribeSpec({

    describe("with HidingInternalsCodeAggregator") {
        val ca = HidingInternalsCodeAggregator()
        ...
        describe("aggregatedCodes") {
            ...
            mapOf(
                ...
                describe(f.print()) {
                    it("should be aggregated to ${e.print()}") {
        ...
        describe("codesStudyDesign - internals") {
            val internals = listOf(
                "1N", "1U", "1Z", "3U", "3Z", "4U", "4X", "4Y", "4Z",
                "5A", "5B", "5C", "5D", "5K", "6P", "6Z", "7M", "7Z", "8Z"
            )
...
private fun <T> Array<T>.print() = joinToString(separator = ",", prefix = "[", postfix = "]")
