...
public class JooqPaperRepoIntegrationTest {
    ...
    public void findingById_forPaper1InGerman() {
        ...
        // @formatter:off
           ...
           +   ",codes=["
           +      "codesOfClass1=["
           +         "Code[code=1F,name=Feinstaub, Partikel,codeClass=CodeClass[id=1],sort=1]"
           +      "],"
           +      "codesOfClass2=["
           +         "Code[code=2N,name=Übrige Länder,codeClass=CodeClass[id=2],sort=2]"
           +      "],"
           +      "codesOfClass3=["
           +         "Code[code=3C,name=Erwachsene (alle),codeClass=CodeClass[id=3],sort=3]"
           +      "],"
           +      "codesOfClass4=["
           +         "Code[code=4G,name=Krebs,codeClass=CodeClass[id=4],sort=7]"
           +      "],"
           +      "codesOfClass5=["
           +         "Code[code=5H,name=Kohortenstudie,codeClass=CodeClass[id=5],sort=7], "
           +         "Code[code=5S,name=Statistik,codeClass=CodeClass[id=5],sort=10]"
           +      "],"
           +      "codesOfClass6=["
           +         "Code[code=6M,name=Mensch,codeClass=CodeClass[id=6],sort=1]"
           +      "],"
           +      "codesOfClass7="
           +         "[Code[code=7L,name=Langfristig,codeClass=CodeClass[id=7],sort=2]"
           +      "],"
           +      "codesOfClass8=["
           +         "Code[code=8O,name=Aussenluft,codeClass=CodeClass[id=8],sort=2]"
           +      "]"
           +    "]"
           + "]");
        // @formatter:on
...
//           +   ",codes=["
//           +      "codesOfClass1=["
//           +         "Code[code=1F,name=Particles, Particulate Matter,codeClass=CodeClass[id=1],sort=1]"
//           +      "],"
//           +      "codesOfClass2=["
//           +         "Code[code=2N,name=not translated,codeClass=CodeClass[id=2],sort=2]"
//           +      "],"
//           +      "codesOfClass3=["
//           +         "Code[code=3C,name=not translated,codeClass=CodeClass[id=3],sort=3]"
//           +      "],"
//           +      "codesOfClass4=["
//           +         "Code[code=4G,name=not translated,codeClass=CodeClass[id=4],sort=7]"
//           +      "],"
//           +      "codesOfClass5=["
//           +         "Code[code=5H,name=not translated,codeClass=CodeClass[id=5],sort=7], "
//           +         "Code[code=5S,name=not translated,codeClass=CodeClass[id=5],sort=10]"
//           +      "],"
//           +      "codesOfClass6=["
//           +         "Code[code=6M,name=not translated,codeClass=CodeClass[id=6],sort=1]"
//           +      "],"
//           +      "codesOfClass7=["
//           +          "Code[code=7L,name=not translated,codeClass=CodeClass[id=7],sort=2]"
//           +      "],"
//           +      "codesOfClass8=["
//           +          "Code[code=8O,name=not translated,codeClass=CodeClass[id=8],sort=2]"
//           +      "]"
//           +    "]"
//           + "]");
//        // @formatter:on
...
//            +   ",codes=["
//            +      "codesOfClass1=["
//            +        "Code[code=1F,name=not translated,codeClass=CodeClass[id=1],sort=1]"
//            +      "],"
//            +      "codesOfClass2=["
//            +         "Code[code=2N,name=not translated,codeClass=CodeClass[id=2],sort=2]"
//            +      "],"
