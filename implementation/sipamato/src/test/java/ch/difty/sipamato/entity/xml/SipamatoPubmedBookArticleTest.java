...
import ch.difty.sipamato.pubmed.ContributionDate;
...
public class SipamatoPubmedBookArticleTest {
    ...
    public void degenerateConstruction_withNullBookDocument_throws() {
        ...
        try {
            new SipamatoPubmedBookArticle(pubmedBookArticle);
            fail("should have thrown exception");
        } catch (Exception ex) {
    ...
    public void canConstructWithMinimalAttributes() {
        ...
        PubmedArticleFacade pa = new SipamatoPubmedBookArticle(pubmedBookArticle);
