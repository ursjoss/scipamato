...
import static ch.difty.sipamato.entity.filter.StringSearchTerm.MatchType.LENGTH;
import static ch.difty.sipamato.entity.filter.StringSearchTerm.MatchType.LIKE;
import static ch.difty.sipamato.entity.filter.StringSearchTerm.MatchType.NONE;
import static ch.difty.sipamato.entity.filter.StringSearchTerm.MatchType.REGEX;
...
public class StringSearchTermEvaluatorIntegrationTest extends SearchTermEvaluatorIntegrationTest<StringSearchTerm, StringSearchTermEvaluator> {
    ...
    private Object[] stringParameters() {
        return new Object[] {
            ...
            new Object[] { ">\"\"", "(SOME >\"\")", "char_length(cast(fn as varchar)) > 0", LENGTH },
