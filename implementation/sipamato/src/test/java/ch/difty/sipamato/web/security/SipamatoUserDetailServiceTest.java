...
public class SipamatoUserDetailServiceTest {

    private SipamatoUserDetailService service;
    ...
    @Before
    public void setUp() {
        service = new SipamatoUserDetailService(userServiceMock);
    }
    ...
    public void loadUserByUsername_withUserFound() {
        ...
        assertThat(usd).isNotNull().isInstanceOf(SipamatoUserDetails.class);
