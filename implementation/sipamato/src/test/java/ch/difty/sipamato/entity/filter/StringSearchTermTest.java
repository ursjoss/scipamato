...
public class StringSearchTermTest {
    ...
    private static final long CONDITION_ID = 6;
    ...
    private void assertTerm(MatchType type, String value, String raw) {
        assertThat(st.getSearchTermType()).isEqualTo(SearchTermType.STRING);
    ...
    public void contains() {
        ...
        st = new StringSearchTerm(CONDITION_ID, FIELD_NAME, raw);
