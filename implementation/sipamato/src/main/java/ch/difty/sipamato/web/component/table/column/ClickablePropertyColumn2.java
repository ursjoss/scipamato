 ...
 * @param <U> the type of an additional argument passed to the (bi)consumer
 */
public class ClickablePropertyColumn2<T, S, U> extends AbstractColumn<T, S> {
    ...
    public ClickablePropertyColumn2(IModel<String> displayModel, String property, SerializableBiConsumer<IModel<T>, U> biConsumer, U arg2) {
        this(displayModel, null, property, biConsumer, arg2);
    }

    public ClickablePropertyColumn2(IModel<String> displayModel, S sort, String property, SerializableBiConsumer<IModel<T>, U> biConsumer, U arg2) {
    ...
    protected void onClick(IModel<T> clicked) {
        biConsumer.accept(clicked, arg2);
    };
