...
package ch.difty.scipamato.core.sync.jooq;
 ...
 *
 * Copy of the original org.springframework.boot.autoconfigure.jooq.JooqExceptionTranslator, which has default access modifier for now.
