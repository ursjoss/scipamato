...
internal class PublicPaperFilterConditionMapperTest : FilterConditionMapperTest<PaperRecord, Paper, PublicPaperFilter>() {
...
")"
 // @formatter:on
    ...
    fun creatingWhereCondition_withPublicationYearFrom_andPublicationYearUntil_searchesRange() {
        ...
        assertThat(mapper.map(filter).toString()).isEqualToIgnoringCase("\"PUBLIC\".\"PAPER\".\"PUBLICATION_YEAR\" between 2016 and 2017")
    }
    ...
    fun creatingWhereCondition_withMethodStudyDesignCodes_searchesStudyDesignCodes() {
        filter.studyDesignCodes = Arrays.asList(StudyDesignCode.EPIDEMIOLOGICAL, StudyDesignCode.OVERVIEW_METHODOLOGY)
    ...
    fun creatingWhereCondition_withCodesOfCodeClass4_searchesCodeClasses() {
        filter.codesOfClass4 = Arrays.asList(Code
                .builder()
                .code("c1")
                .build(), Code
                .builder()
