...
public class SearchOrderFilterConditionMapperTest extends FilterConditionMapperTest<SearchOrderRecord, ch.difty.scipamato.core.db.tables.SearchOrder, SearchOrderFilter> {
