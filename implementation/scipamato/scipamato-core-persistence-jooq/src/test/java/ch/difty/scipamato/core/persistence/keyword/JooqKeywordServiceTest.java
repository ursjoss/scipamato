...
class JooqKeywordServiceTest {
    ...
    @Test
    void newUnpersistedKeywordDefinition_delegatesToRepo() {
    ...
    @Test
    void findingPageOfKeywordDefinitions_delegatesToRepo() {
    ...
    @Test
    void countingKeywords_delegatesToRepo() {
    ...
    @Test
    void insertingKeywordDefinition_delegatesToRepo() {
    ...
    @Test
    void updatingKeywordDefinition_delegatesToRepo() {
    ...
    @Test
    void savingOrUpdatingKeywordDefinition_withNullId_callsInsert() {
    ...
    @Test
    void savingOrUpdatingKeywordDefinition_withNonNullId_callsUpdate() {
    ...
    @Test
    void deletingKeywordDefinition_delegatesToRepo() {
        final int id = 11;
