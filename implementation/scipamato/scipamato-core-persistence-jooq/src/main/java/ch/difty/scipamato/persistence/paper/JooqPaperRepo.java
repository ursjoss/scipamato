...
public class JooqPaperRepo extends JooqEntityRepo<PaperRecord, Paper, Long, ch.difty.scipamato.db.tables.Paper, PaperRecordMapper, PaperFilter> implements PaperRepository {
    ...
    @Autowired
    public JooqPaperRepo(@Qualifier("dslContext") DSLContext dsl, PaperRecordMapper mapper, JooqSortMapper<PaperRecord, Paper, ch.difty.scipamato.db.tables.Paper> sortMapper,
