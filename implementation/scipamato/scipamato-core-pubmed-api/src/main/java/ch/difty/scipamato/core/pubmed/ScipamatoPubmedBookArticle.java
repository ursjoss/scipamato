...
public class ScipamatoPubmedBookArticle extends AbstractPubmedArticleFacade {
    ...
    protected ScipamatoPubmedBookArticle(final PubmedBookArticle pubmedBookArticle) {
        ...
        setPmId(bookDocument.getPMID() != null ? bookDocument.getPMID()
            .getvalue() : null);
        ...
        setPublicationYear(bookDocument.getContributionDate() != null ? bookDocument.getContributionDate()
            .getYear()
            .getvalue() : null);
        setLocation(getLocationFrom(bookDocument));
        setTitle(bookDocument.getArticleTitle() != null ? bookDocument.getArticleTitle()
            .getvalue() : null);
    ...
    private String getLocationFrom(BookDocument bookDocument) {
        return bookDocument.getLocationLabel()
            .stream()
