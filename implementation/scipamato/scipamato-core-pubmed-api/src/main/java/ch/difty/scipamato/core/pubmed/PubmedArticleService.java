...
/**
 * Service to handle articles from PubMed and present it in a SciPaMaTo specific representation.
 *
 * @author u.joss
 */
public interface PubmedArticleService {
    ...
    /**
     * Extracts pubmed articles and pubmed book articles from a a source string. It is the implementation that determines the type and format of the content.
     *
