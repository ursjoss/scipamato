...
import static ch.difty.scipamato.entity.Paper.AUTHORS;
import static ch.difty.scipamato.entity.Paper.COMMENT;
import static ch.difty.scipamato.entity.Paper.CREATED;
import static ch.difty.scipamato.entity.Paper.CREATED_BY;
import static ch.difty.scipamato.entity.Paper.DOI;
import static ch.difty.scipamato.entity.Paper.EXPOSURE_ASSESSMENT;
import static ch.difty.scipamato.entity.Paper.EXPOSURE_POLLUTANT;
import static ch.difty.scipamato.entity.Paper.FIRST_AUTHOR;
import static ch.difty.scipamato.entity.Paper.FIRST_AUTHOR_OVERRIDDEN;
import static ch.difty.scipamato.entity.Paper.GOALS;
import static ch.difty.scipamato.entity.Paper.INTERN;
import static ch.difty.scipamato.entity.Paper.LAST_MOD;
import static ch.difty.scipamato.entity.Paper.LAST_MOD_BY;
import static ch.difty.scipamato.entity.Paper.LOCATION;
import static ch.difty.scipamato.entity.Paper.MAIN_CODE_OF_CODECLASS1;
import static ch.difty.scipamato.entity.Paper.METHODS;
import static ch.difty.scipamato.entity.Paper.METHOD_CONFOUNDERS;
import static ch.difty.scipamato.entity.Paper.METHOD_OUTCOME;
import static ch.difty.scipamato.entity.Paper.METHOD_STATISTICS;
import static ch.difty.scipamato.entity.Paper.METHOD_STUDY_DESIGN;
import static ch.difty.scipamato.entity.Paper.NUMBER;
import static ch.difty.scipamato.entity.Paper.ORIGINAL_ABSTRACT;
import static ch.difty.scipamato.entity.Paper.PMID;
import static ch.difty.scipamato.entity.Paper.POPULATION;
import static ch.difty.scipamato.entity.Paper.POPULATION_DURATION;
import static ch.difty.scipamato.entity.Paper.POPULATION_PARTICIPANTS;
import static ch.difty.scipamato.entity.Paper.POPULATION_PLACE;
import static ch.difty.scipamato.entity.Paper.PUBL_YEAR;
import static ch.difty.scipamato.entity.Paper.RESULT;
import static ch.difty.scipamato.entity.Paper.RESULT_EFFECT_ESTIMATE;
import static ch.difty.scipamato.entity.Paper.RESULT_EXPOSURE_RANGE;
import static ch.difty.scipamato.entity.Paper.RESULT_MEASURED_OUTCOME;
import static ch.difty.scipamato.entity.Paper.TITLE;
