...
public abstract class EditablePaperPanel extends PaperPanel<Paper> {
    ...
    protected PaperSummaryShortDataSource getSummaryShortDataSource() {
        ...
        ScipamatoPdfExporterConfiguration config = new ScipamatoPdfExporterConfiguration.Builder(headerPart, getModelObject().getId()).withCreator(brand)
                ...
                .withCompression()
                .build();
        return new PaperSummaryShortDataSource(getModelObject(), populationPlaceLabel, methodsLabel, resultEffectEstimateLabel, commentLabel, headerPart, brand, config);
    }
