...
public class PaperSummaryTableReportResourceReferenceTest extends JasperReportResourceReferenceTest<PaperSummaryTableReportResourceReference> {
    ...
    protected String getResourceReferencePath() {
        return "ch.difty.scipamato.web.resources.jasper.PaperSummaryTableReportResourceReference";
    }
}
