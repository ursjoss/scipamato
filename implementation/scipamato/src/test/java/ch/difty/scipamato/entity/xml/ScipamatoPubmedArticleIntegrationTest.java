package ch.difty.scipamato.entity.xml;
...
import ch.difty.scipamato.pubmed.ArticleDate;
import ch.difty.scipamato.pubmed.Author;
import ch.difty.scipamato.pubmed.AuthorList;
import ch.difty.scipamato.pubmed.ChemicalList;
import ch.difty.scipamato.pubmed.Day;
...
import ch.difty.scipamato.pubmed.KeywordList;
...
import ch.difty.scipamato.pubmed.MeshHeadingList;
...
public class ScipamatoPubmedArticleIntegrationTest extends PubmedIntegrationTest {
    ...
    @Test
    public void feedIntoScipamatoArticle_26607712_notHavingPaginationButElocationIdOfTypePii_usesThat() throws XmlMappingException, IOException {
