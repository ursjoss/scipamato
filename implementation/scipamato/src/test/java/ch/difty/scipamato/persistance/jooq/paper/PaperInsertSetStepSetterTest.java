...
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.AUTHORS;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.COMMENT;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.DOI;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.EXPOSURE_ASSESSMENT;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.EXPOSURE_POLLUTANT;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.FIRST_AUTHOR;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.FIRST_AUTHOR_OVERRIDDEN;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.GOALS;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.ID;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.INTERN;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.LOCATION;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.MAIN_CODE_OF_CODECLASS1;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.METHODS;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.METHOD_CONFOUNDERS;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.METHOD_OUTCOME;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.METHOD_STATISTICS;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.METHOD_STUDY_DESIGN;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.NUMBER;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.ORIGINAL_ABSTRACT;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.PM_ID;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.POPULATION;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.POPULATION_DURATION;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.POPULATION_PARTICIPANTS;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.POPULATION_PLACE;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.PUBLICATION_YEAR;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.RESULT;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.RESULT_EFFECT_ESTIMATE;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.RESULT_EXPOSURE_RANGE;
import static ch.difty.scipamato.persistance.jooq.paper.PaperRecordMapperTest.RESULT_MEASURED_OUTCOME;
...
import ch.difty.scipamato.persistance.jooq.InsertSetStepSetterTest;
