...
public class UserIdOfUserCacheKeyGeneratorTest {

    private static final Integer USER_ID = 1;
    private static final String NOF_ERROR_MSG = "No user argument found in invocation context";

    private final User user = new User(USER_ID, "un", "fn", "ln", "em", "pw", true, Arrays.asList(Role.USER, Role.ADMIN));

    private final UserIdOfUserCacheKeyGenerator generator = new UserIdOfUserCacheKeyGenerator();
    ...
    public void generatingCacheKey_withCacheInvocationParameterForNonUserClass_throws() {
        ...
        cips[0] = new CacheInvocationParameter() {
            ...
            @Override
            public Object getValue() {
                return USER_ID + Integer.valueOf(1);
            }
    ...
    public void generatingCacheKey_withValidCacheInvocationParameter_() {
        ...
        ids[0] = USER_ID;
        GeneratedCacheKey dgck = new DefaultGeneratedCacheKey(ids);
