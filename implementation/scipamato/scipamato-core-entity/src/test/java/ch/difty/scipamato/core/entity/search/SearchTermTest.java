...
public class SearchTermTest {
    ...
    public void equality_withNonEqualValuesInNonIds() {
        assertInequalityBetween(SearchTerms.newSearchTerm(12, 2, 3l, "fn4", "foo*"),
            SearchTerms.newSearchTerm(12, 2, 3l, "fn3", "foo*"));
        assertInequalityBetween(SearchTerms.newSearchTerm(12, 2, 3l, "fn3", "bar*"),
            SearchTerms.newSearchTerm(12, 2, 3l, "fn3", "foo*"));
    }
