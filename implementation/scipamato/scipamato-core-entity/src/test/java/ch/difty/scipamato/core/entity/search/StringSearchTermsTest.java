...
import ch.difty.scipamato.core.entity.search.StringSearchTerms;
...
public class StringSearchTermsTest {
    ...
    public void compareEmptySearchTerms_withEmptySearchTerms_match() {
        ...
        st1.put(KEY, SearchTerms.newStringSearchTerm(KEY, VALUE));
        st2.put(KEY, SearchTerms.newStringSearchTerm(KEY, VALUE));
    }
    ...
    public void compareEmptySearchTerms_withDoubleIdenticalKeyValueSearchTerm_match() {
        st1.put("key1", SearchTerms.newStringSearchTerm("key1", VALUE));
        st2.put("key1", SearchTerms.newStringSearchTerm("key1", VALUE));
        st1.put("key2", SearchTerms.newStringSearchTerm("key2", "value2"));
        st2.put("key2", SearchTerms.newStringSearchTerm("key2", "value2"));
    ...
    public void compareEmptySearchTerms_withDifferentSearchTermValues_dontMatch() {
        st1.put(KEY, SearchTerms.newStringSearchTerm(KEY, VALUE));
        st2.put(KEY, SearchTerms.newStringSearchTerm(KEY, "valueX"));
