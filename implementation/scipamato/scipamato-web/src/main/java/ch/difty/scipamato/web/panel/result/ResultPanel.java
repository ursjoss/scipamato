...
public class ResultPanel extends AbstractPanel<Void> {
    ...
    private void makeAndQueuePdfSummaryLink(String id) {
        ...
        ReportHeaderFields rhf = new ReportHeaderFields.Builder(headerPart, brand)
            .withPopulation(new StringResourceModel("population" + LABEL_RECOURCE_TAG, this, null).getString())
    ...
    private void makeAndQueuePdfReviewLink(String id) {
        ...
        ReportHeaderFields rhf = new ReportHeaderFields.Builder("", brand)
            .withNumber(new StringResourceModel("number" + LABEL_RECOURCE_TAG, this, null).getString())
