...
internal class HidingInternalsCodeAggregatorTest {
    ...
    fun gettingAggregatedCodes(input: Array<String>?, codes: Array<String>?) {
        val internals = arrayOf("1N", "1U", "1Z", "3U", "3Z", "4U", "4X", "4Y", "4Z", "5A", "5B", "5C", "5D", "5K", "6P", "6Z", "7M", "7Z", "8Z")
    ...
    fun gettingAllCodeTypes(input: Array<String>?, codes: Array<String>, codesPopulation: Array<Short>?, codesStudyDesign: Array<Short>?) {
        val internals = arrayOf("1N", "1U", "1Z", "3U", "3Z", "4U", "4X", "4Y", "4Z", "5A", "5B", "5C", "5D", "5K", "6P", "6Z", "7M", "7Z", "8Z")
        ca.setInternalCodes(listOf(*internals))
        ca.load(input)
        assertThat(ca.aggregatedCodes).isEqualTo(codes)
