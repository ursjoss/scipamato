...
internal class AuditSearchTermTest {
    ...
    private fun assertSingleToken(st: AuditSearchTerm, fieldName: String, tt: TokenType, userRawData: String?, userData: String?,
                                  dateRawData: String?, dateData: String?) {
    ...
    fun lexingMinimumDate_findsDate() {
        ...
        assertSingleToken(st, fieldName, TokenType.GREATEROREQUAL, null, null, "2017-12-01 23:15:13", "2017-12-01 23:15:13")
    }
    ...
    fun lexingMinimumDateWithoutTime_usesTimestampAtStartOfDay() {
        ...
        assertSingleToken(st, fieldName, TokenType.GREATEROREQUAL, null, null, "2017-12-01", "2017-12-01 00:00:00")
    }
    ...
    fun lexingMinimumDateQuoted_findsDate() {
        val fieldName = CREATED
        val st = AuditSearchTerm(fieldName, ">=\"2017-12-01 23:15:13\"")
        assertSingleToken(st, fieldName, TokenType.GREATEROREQUALQUOTED, null, null, "2017-12-01 23:15:13", "2017-12-01 23:15:13")
    }
    ...
    fun lexingMinimumDateExcluded_findsDate() {
        val fieldName = CREATED
        val st = AuditSearchTerm(fieldName, ">2017-12-01 23:15:13")
        assertSingleToken(st, fieldName, TokenType.GREATERTHAN, null, null, "2017-12-01 23:15:13", "2017-12-01 23:15:13")
    }
    ...
    fun lexingMinimumDateExcludedWithoutDate_usesTimestampAtEndOfDay() {
        val fieldName = CREATED
        val st = AuditSearchTerm(fieldName, ">2017-12-01")
        assertSingleToken(st, fieldName, TokenType.GREATERTHAN, null, null, "2017-12-01", "2017-12-01 23:59:59")
    }
    ...
    fun lexingMinimumDateExcludedQuoted_findsDate() {
        ...
        val st = AuditSearchTerm(fieldName, ">\"2017-12-01 23:15:13\"")
        assertSingleToken(st, fieldName, TokenType.GREATERTHANQUOTED, null, null, "2017-12-01 23:15:13", "2017-12-01 23:15:13")
    }
    ...
    fun lexingMaximumDate_findsDate() {
        val fieldName = CREATED
        val st = AuditSearchTerm(fieldName, "<=2017-12-01 23:15:13")
        assertSingleToken(st, fieldName, TokenType.LESSOREQUAL, null, null, "2017-12-01 23:15:13", "2017-12-01 23:15:13")
    }
    ...
    fun lexingMaximumDateWithoutTime_usesTimestampAtEndOfDay() {
        val fieldName = CREATED
        val st = AuditSearchTerm(fieldName, "<=2017-12-01")
        assertSingleToken(st, fieldName, TokenType.LESSOREQUAL, null, null, "2017-12-01", "2017-12-01 23:59:59")
    }
    ...
    fun lexingMaximumDateQuoted_findsDate() {
        val fieldName = CREATED
        val st = AuditSearchTerm(fieldName, "<=\"2017-12-01 23:15:13\"")
        assertSingleToken(st, fieldName, TokenType.LESSOREQUALQUOTED, null, null, "2017-12-01 23:15:13", "2017-12-01 23:15:13")
    }
    ...
    fun lexingMaximumDateExcludedQuoted_findsDate() {
        val fieldName = CREATED
        val st = AuditSearchTerm(fieldName, "<\"2017-12-01 23:15:13\"")
        assertSingleToken(st, fieldName, TokenType.LESSTHANQUOTED, null, null, "2017-12-01 23:15:13", "2017-12-01 23:15:13")
    }
    ...
    fun lexingMaximumDateExcludedQuotedWithoutTime_usesTimestampAtStartOfDay() {
        val fieldName = CREATED
        val st = AuditSearchTerm(fieldName, "<\"2017-12-01\"")
        assertSingleToken(st, fieldName, TokenType.LESSTHANQUOTED, null, null, "2017-12-01", "2017-12-01 00:00:00")
    }
    ...
    fun lexingMaximumDateExcluded_findsDate() {
        val fieldName = CREATED
        val st = AuditSearchTerm(fieldName, "<2017-12-01 23:15:13")
        assertSingleToken(st, fieldName, TokenType.LESSTHAN, null, null, "2017-12-01 23:15:13", "2017-12-01 23:15:13")
    }
    ...
    fun lexingExactDate_findsDate() {
        val fieldName = CREATED
        val st = AuditSearchTerm(fieldName, "2017-12-01 23:15:13")
        assertSingleToken(st, fieldName, TokenType.EXACT, null, null, "2017-12-01 23:15:13", "2017-12-01 23:15:13")
    }
    ...
    fun lexingDateRangeQuoted_withEquals_findsBothDates() {
        ...
        assertSingleToken(st, fieldName, TokenType.RANGEQUOTED, null, null, "2017-12-01 10:15:13-2017-12-02 23:12:11",
    ...
    fun lexingDateRangeUnquoted_withEquals_findsBothDates() {
        val fieldName = CREATED
        val st = AuditSearchTerm(fieldName, "=2017-12-01 10:15:13-2017-12-02 23:12:11")
        assertSingleToken(st, fieldName, TokenType.RANGE, null, null, "2017-12-01 10:15:13-2017-12-02 23:12:11",
                "2017-12-01 10:15:13-2017-12-02 23:12:11")
    }
    ...
    fun lexingDateRangeQuoted_withDatePartOnly_findsBothDatesExtended() {
        ...
        assertSingleToken(st, fieldName, TokenType.RANGEQUOTED, null, null, "2017-12-01 00:00:00-2017-12-02 23:59:59",
    ...
    fun lexingDateRangeUnquoted_withDatePartOnly_findsBothDatesExtended() {
        val fieldName = CREATED
        val st = AuditSearchTerm(fieldName, "=2017-12-01-2017-12-02")
        assertSingleToken(st, fieldName, TokenType.RANGE, null, null, "2017-12-01 00:00:00-2017-12-02 23:59:59",
                "2017-12-01 00:00:00-2017-12-02 23:59:59")
    }
    ...
    fun lexingDateRange_withMixedDateParts_findsBothDatesExtended() {
        ...
        assertSingleToken(st, fieldName, TokenType.RANGEQUOTED, null, null, "2017-12-01 12:13:14-2017-12-02 23:59:59",
    ...
    fun lexingExactDateQuoted_findsDate() {
        val fieldName = CREATED
        val st = AuditSearchTerm(fieldName, "\"2017-12-01 23:15:13\"")
        assertSingleToken(st, fieldName, TokenType.EXACTQUOTED, null, null, "2017-12-01 23:15:13", "2017-12-01 23:15:13")
    }
    ...
    fun byMatchType_withValidMatchTypeGREATER_OR_EQUAL() {
        assertThat(TokenType.byMatchType(MatchType.GREATER_OR_EQUAL)).containsExactly(TokenType.GREATEROREQUALQUOTED, TokenType.GREATEROREQUAL)
    }

    @Test
    fun byMatchType_withValidMatchTypeGREATER_THAN() {
        assertThat(TokenType.byMatchType(MatchType.GREATER_THAN)).containsExactly(TokenType.GREATERTHANQUOTED, TokenType.GREATERTHAN)
    }

    @Test
    fun byMatchType_withValidMatchTypeLESS_OR_EQUAL() {
        assertThat(TokenType.byMatchType(MatchType.LESS_OR_EQUAL)).containsExactly(TokenType.LESSOREQUALQUOTED, TokenType.LESSOREQUAL)
    }

    @Test
    fun byMatchType_withValidMatchTypeLESS_THAN() {
        assertThat(TokenType.byMatchType(MatchType.LESS_THAN)).containsExactly(TokenType.LESSTHANQUOTED, TokenType.LESSTHAN)
    }
