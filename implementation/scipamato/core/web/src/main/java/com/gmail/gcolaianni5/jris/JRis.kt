...
object JRis {
    ...
    private val risTagContexts: Set<TagContext<*>> = setOf(
            TagContext("TY", Type::class, { r: RisRecord -> r.type }, { r, v -> r.type = v as Type }),
            ...
            TagContext("AB", String::class, { r: RisRecord -> r.abstr }, { r, v -> r.abstr = v as String }),
            ...
            TagContext<List<String>>("AU", String::class, { r: RisRecord -> r.authors }, { r, v -> r.authors.add(v as String) }),
            ...
            TagContext("DB", String::class, { r: RisRecord -> r.databaseName }, { r, v -> r.databaseName = v as String? }),
            TagContext("DO", String::class, { r: RisRecord -> r.doi }, { r, v -> r.doi = v as String? }),
            ...
            TagContext<Int>("EP", String::class, { r: RisRecord -> r.endPage }, { r, v -> r.endPage = v as Int? }),
            TagContext("ED", String::class, { r: RisRecord -> r.edition }, { r, v -> r.edition = v as String? }),
            TagContext("ID", String::class, { r: RisRecord -> r.referenceId }, { r, v -> r.referenceId = v as String? }),
            TagContext<Int>("IS", String::class, { r: RisRecord -> r.issueNumber }, { r, v -> r.issueNumber = v as Int? }),
            ...
            TagContext("JO", String::class, { r: RisRecord -> r.periodicalNameFullFormatJO }, { r, v -> r.periodicalNameFullFormatJO = v as String? }),
            TagContext<List<String>>("KW", String::class, { r: RisRecord -> r.keywords }, { r, v -> r.keywords.add(v as String) }),
            TagContext<List<String>>("L1", String::class, { r: RisRecord -> r.pdfLinks }, { r, v -> r.pdfLinks.add(v as String) }),
            TagContext<List<String>>("L2", String::class, { r: RisRecord -> r.fullTextLinks }, { r, v -> r.fullTextLinks.add(v as String) }),
            TagContext<List<String>>("L3", String::class, { r: RisRecord -> r.relatedRecords }, { r, v -> r.relatedRecords.add(v as String) }),
            TagContext<List<String>>("L4", String::class, { r: RisRecord -> r.images }, { r, v -> r.images.add(v as String) }),
            ...
            TagContext("M1", String::class, { r: RisRecord -> r.number }, { r, v -> r.number = v as Int? }),
            TagContext("M2", String::class, { r: RisRecord -> r.miscellaneous2 }, { r, v -> r.miscellaneous2 = v as String? }),
            TagContext("M3", String::class, { r: RisRecord -> r.typeOfWork }, { r, v -> r.typeOfWork = v as String? }),
            ...
            TagContext("PY", String::class, { r: RisRecord -> r.publicationYear }, { r, v -> r.publicationYear = v as String? }),
            ...
            TagContext("SP", String::class, { r: RisRecord -> r.startPage }, { r, v -> r.startPage = v as Int? }),
            ...
            TagContext("TI", String::class, { r: RisRecord -> r.title }, { r, v -> r.title = v as String? }),
            ...
            TagContext("VL", String::class, { r: RisRecord -> r.volumeNumber }, { r, v -> r.volumeNumber = v as String? }),
    ...
    private fun List<RisRecord>.asString(): String {
        ...
        forEach { record ->
            ...
            risTagContexts.forEach { currentTagContext ->
