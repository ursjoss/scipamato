...
object JRis {
    ...
    private val risTagContexts: Set<TagContext<*>> = setOf(
            ...
            TagContext<Int>("EP", Int::class, { r: RisRecord -> r.endPage }, { r, v -> r.endPage = v as Int? }),
            ...
            TagContext("IS", String::class, { r: RisRecord -> r.issue }, { r, v -> r.issue = v as String? }),
            ...
            TagContext<Long>("M1", Long::class, { r: RisRecord -> r.number }, { r, v -> r.number = v as Long? }),
            ...
            TagContext<Int>("SP", Int::class, { r: RisRecord -> r.startPage }, { r, v -> r.startPage = v as Int? }),
