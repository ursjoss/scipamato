...
/**
 * The implementation of the {@link AuthorParserFactory} provides a configured
 * {@link AuthorParser} able parse the provided property String
 * {@code authorString}.
 *
 * @author u.joss
 */
...
public interface AuthorParserFactory {
     ...
     * provided {@code author string}. Returns a {@code PUBMED} {@link AuthorParser}
