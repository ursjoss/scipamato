...
import ch.difty.scipamato.core.web.pages.paper.provider.SearchConditionProvider;
import ch.difty.scipamato.core.web.pages.paper.search.PaperSearchCriteriaPage;
