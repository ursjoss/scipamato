...
/**
 * A TextField that is mapped to a <code>java.time.LocalDate</code> object.
 * <p>
 ...
 *
 * <strong>Note:</strong> This class was copied from wicket-bootstrap (DateTextField) in order to create a
 * proof of concept for using the new wicket DateTextField functionality based on java.time instead of java.util.date
 * introduced in wicket 8. The idea is to integrate this back into wicket-bootstrap.
 *
 * @author miha
 * @author Urs Joss
 */
public class LocalDateTextField extends org.apache.wicket.extensions.markup.html.form.datetime.LocalDateTextField {
        ...
        protected AbstractAjaxEvent createNew(Event event, IAjaxEventHandler handler, boolean updateModel) {
            return new AbstractAjaxEvent(event, handler, updateModel) {
                ...
                protected CharSequence getBody() {
                    return ch.difty.scipamato.common.LocalDateTextField.DatePickerAbstractDefaultAjaxBehavior.this.getCallbackScript().toString();
                }
            };
        }
     ...
     */
    public ch.difty.scipamato.common.LocalDateTextField with(LocalDateTextFieldConfig config) {
        if (config != null) {
            this.config = config;
        }
        return this;
     ...
     * @return this
     */
    public ch.difty.scipamato.common.LocalDateTextField addEvent(Event type, AbstractEventHandler handler) {
     ...
     */
    public ch.difty.scipamato.common.LocalDateTextField addAjaxEvent(Event type, IAjaxEventHandler evenHandler) {
     ...
     */
    public ch.difty.scipamato.common.LocalDateTextField addAjaxEvent(Event type, IAjaxEventHandler evenHandler, boolean updateModel) {
     ...
     * @return this
     */
    public ch.difty.scipamato.common.LocalDateTextField removeEvent(Event type) {
