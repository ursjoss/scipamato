...
image:https://github.com/jococo-ch/scipamato/actions/workflows/codeql.yml/badge.svg?branch=main&event=push[CodeQL, link=https://github.com/jococo-ch/scipamato/actions/workflows/codeql.yml]
