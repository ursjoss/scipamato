image::https://img.shields.io/github/license/ursjoss/scipamato.svg[LICENSE] image::https://sonarcloud.io/api/project_badges/measure?project=ursjoss_scipamato&metric=alert_status[https://sonarcloud.io/dashboard?id=ursjoss_scipamato]
